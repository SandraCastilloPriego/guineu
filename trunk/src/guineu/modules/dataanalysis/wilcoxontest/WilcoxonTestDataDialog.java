 ...
 * @author  SCSANDRA
 */
public class WilcoxonTestDataDialog extends JDialog {

    private Logger logger = Logger.getLogger(this.getClass().getName());
    private Dataset dataset;
    private WilcoxonTestDataModel group1, group2, from;
    private ExitCode exit = ExitCode.UNKNOWN;

    /** Creates new form TtestDataDialog */
    public WilcoxonTestDataDialog(Dataset dataset) {
        ...
        try {
            this.from = new WilcoxonTestDataModel("Experiment Names");
            this.group1 = new WilcoxonTestDataModel("Group1 - Experiment Names");
            this.group2 = new WilcoxonTestDataModel("Group2 - Experiment Names");
