...
public class ReportParameters extends SimpleParameterSet {
        ...
        public static final BooleanParameter areaOrHeight = new BooleanParameter(
                "Use area ",
                "Select the check box if you want to use area instead of height", true);

        public ReportParameters() {
                super(new UserParameter[]{filename, reportFilename, areaOrHeight});
        }
}
