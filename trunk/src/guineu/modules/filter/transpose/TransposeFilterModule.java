 ...
 * @author scsandra
 */
public class TransposeFilterModule implements GuineuProcessingModule {

        public static final String MODULE_NAME = "Transpose Dataset";
        ...
        public Task[] runModule(ParameterSet parameters) {
                ...
                for (int i = 0; i < datasets.length; i++) {
                        tasks[i] = new TransposeFilterTask(datasets[i]);
                }
