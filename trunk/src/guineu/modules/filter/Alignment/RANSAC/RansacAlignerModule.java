 ...
 * 
 */
public class RansacAlignerModule implements GuineuProcessingModule {

        public static final String MODULE_NAME = "Ransac aligner";
        ...
        public Task[] runModule(ParameterSet parameters) {
                ...
                Task task = new RansacAlignerTask(peakLists, (RansacAlignerParameters) parameters);
