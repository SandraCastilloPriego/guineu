 ...
 * @author scsandra
 */
public class SaveLCMSFileModule implements GuineuModule {

        public static final String MODULE_NAME = "Save LCMS Data set";
        private Dataset[] datasets;
        private SaveLCMSParameters parameters = new SaveLCMSParameters();
