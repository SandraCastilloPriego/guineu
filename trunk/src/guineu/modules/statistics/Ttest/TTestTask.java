...
public class TTestTask implements Task {
    ...
    public TTestTask(String[] group1, String[] group2, SimpleDataset dataset, Desktop desktop) {
        this.group1 = group1;
        this.group2 = group2;
    ...
    public void run() {
        try {
            ...
            progress = 0.5f;
            SimpleDataset newDataset = new SimpleDataset("T_Test - " + dataset.getDatasetName());
