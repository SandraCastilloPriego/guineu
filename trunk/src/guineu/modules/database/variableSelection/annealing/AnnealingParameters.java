 ...
 * @author scsandra
 */
public class AnnealingParameters extends SimpleParameterSet {
        ...
        public static final ComboParameter<String> groups = new ComboParameter<String>(
         ...
         public static final IntegerParameter numberOfParameters = new IntegerParameter(
                "Max number of variables", "Maximun number of variables", 3);

        public AnnealingParameters(String[] parameters) {
                super(new UserParameter[]{groups, numberOfParameters});
