...
public class newParameterDialog extends javax.swing.JPanel {
    ...
    DefaultComboBoxModel tissueModel = new DefaultComboBoxModel(new String[]{"All","Liver", "..."});
   ...
   /** Creates new form newParameterDialog */
    ...
    private void initComponents() {
        ...
        typeParameterCB.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tissue", "Organism", "Subtype" }));
