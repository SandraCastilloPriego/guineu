...
public class MZmineData {
    ...
    public Vector<MZlipidStore> possibleLipids;
    public double ppm = 40;

    public MZmineData() {
        this.possibleLipids = new Vector<MZlipidStore>();
    ...
    public void setCommonName(MZlipidStore lipid, String Name) {
        ...
        try {
            ...
            } else if (lipid.CExpected.compareTo("NOIDEA") == 0) {
                lipid.setCommonName(Name);
            }
        } catch (Exception e) {
