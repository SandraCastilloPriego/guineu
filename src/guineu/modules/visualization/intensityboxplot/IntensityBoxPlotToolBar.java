 ...
 */
class IntensityBoxPlotToolBar extends JToolBar implements ActionListener {
    ...
    private IntensityBoxPlotFrame frame;
    private JButton linesVisibleButton, setupAxesButton;

    IntensityBoxPlotToolBar(IntensityBoxPlotFrame frame) {
