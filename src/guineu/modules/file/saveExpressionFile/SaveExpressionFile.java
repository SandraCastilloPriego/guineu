...
public class SaveExpressionFile implements GuineuModule, TaskListener {
    ...
    public ExitCode setupParameters() {
        try {
            ParameterSetupDialog dialog = new ParameterSetupDialog("Expression Table View parameters", parameters);
    ...
    public Task[] runModule() {
        ...
        String path = (String) parameters.getParameterValue(SaveExpressionParameters.Expressionfilename);
