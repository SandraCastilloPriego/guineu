 ...
 * @author scsandra
 */
public class mediaFilterModule implements GuineuProcessingModule {

        public static final String MODULE_NAME = "Median";
        ...
        public Task[] runModule(ParameterSet parameters) {
                ...
                tasks[0] = new mediaFilterTask(datasets);
