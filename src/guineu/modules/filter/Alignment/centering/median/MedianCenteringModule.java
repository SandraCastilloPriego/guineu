...
public class MedianCenteringModule implements GuineuProcessingModule {

        public static final String MODULE_NAME = "Median centering";
        ...
        public Task[] runModule(ParameterSet parameters) {
                ...
                if ((peakLists == null) || (peakLists.length == 0)) {
                        GuineuCore.getDesktop().displayErrorMessage("Please select peak lists for Median centering");
                        return null;
                }
