...
{	
			...
			ScoreAlignmentParameters params)
	{
		...
		if (rtiDiff >(Double)params.getParameterValue(ScoreAlignmentParameters.rtiLax) ){return WORST_SCORE;}
		double rt2Diff = Math.abs(path.getRT2() - peak.getRT2());
		if (rt2Diff > (Double)params.getParameterValue(ScoreAlignmentParameters.rt2Lax)){return WORST_SCORE;}
		double rt1Diff = Math.abs(path.getRT1() - peak.getRT1());
		if (rt1Diff > (Double)params.getParameterValue(ScoreAlignmentParameters.rt1Lax)){return WORST_SCORE;}
