...
{	
	...
	public static enum SortingMode {REVERSEMASS, REVERSEINTENSITY}
...
//		}
	...
	public SortingMode getSortingMode(){return _sortMode;}
	
	protected int[] peakMasses(){return _masses;}
	protected int[] peakIntensities(){return _intensities;}
	
	public int[] getMasses(){return peakMasses().clone();}
	public int[] getIntensities(){return peakIntensities().clone();}
...
//		int[] peakIntensities = peakIntensities();
		if (peakIntensities == null || peakIntensities.length == 0){return "EMPTY";}
		else
		{
	...
	public Spectrum combineWith(Spectrum other)
	{
		...
		while(true)
		{
			...
			while((mass2 > mass1 || i == len1) && j < len2)
			{
				...
				if (j < len2){mass2 = other._masses[j];}
