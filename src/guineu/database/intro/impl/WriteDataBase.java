            ...
            for (PeakListRow row : QCDataset.getRowsDB()) {
                ...
                try {                  
                    statement.executeUpdate("INSERT INTO QCSAMPLE (DATASETID," +
                            "SAMPLE_NAME, LYSOPC_RT, LYSOPC_HEIGHT_AREA, LYSOPC_HEIGHT_RATIO," +
                            " PC_RT, PC_HEIGHT_AREA, PC_HEIGHT_RATIO, TG_RT, TG_HEIGHT_AREA, " +
                            "TG_HEIGHT_RATIO, DATESET, TIMESET, LYSOPC_HEIGHT, PC_HEIGHT, TG_HEIGHT," +
                            "S_LYSOPC_HEIGHT, S_LYSOPC_RT, S_PC_HEIGHT, S_PC_RT, S_TG_HEIGHT, S_TG_RT)" +
                            " VALUES ( '" + (int) QC_ID +
                            "', '" + (String) peaks[17] +
                            "', '" + Double.parseDouble((String) peaks[20]) +
                            "', '" + Double.parseDouble((String) peaks[19]) +
                            "', '" + Double.parseDouble((String) peaks[18]) +
                            "', '" + Double.parseDouble((String) peaks[16]) +
                            "', '" + Double.parseDouble((String) peaks[15]) +
                            "', '" + Double.parseDouble((String) peaks[14]) +
                            "', '" + Double.parseDouble((String) peaks[13]) +
                            "', '" + Double.parseDouble((String) peaks[12]) +
                            "', '" + Double.parseDouble((String) peaks[11]) +
                            "', '" + dfm.parse(peaks[10].toString()).toString() +
                            "', '" + (String) peaks[9] +
                            "', '" + Double.parseDouble((String) peaks[1]) +
                            "', '" + Double.parseDouble((String) peaks[2]) +
                            "', '" + Double.parseDouble((String) peaks[3]) +
                            "', '" + Double.parseDouble((String) peaks[4]) +
                            "', '" + Double.parseDouble((String) peaks[5]) +
                            "', '" + Double.parseDouble((String) peaks[6]) +
                            "', '" + Double.parseDouble((String) peaks[7]) +
                            "', '" + Double.parseDouble((String) peaks[8]) +
                            "', '" + Double.parseDouble((String) peaks[0]) + "') ");
